...
public class BrowseActivity extends Activity implements View.OnClickListener{
    ...
    ImageView iv_pop_poster,iv_pop_poster1,iv_pop_poster2,iv_pop_poster3,iv_pop_poster4,
            iv_new_poster,iv_new_poster1,iv_new_poster2,iv_new_poster3,iv_new_poster4,
            iv_my_poster,iv_my_poster1,iv_my_poster2,iv_my_poster3,iv_my_poster4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_menu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                switch (position){
                    case 0:
                        Intent intent = new Intent(BrowseActivity.this,PopVideoActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(BrowseActivity.this,NewVideoActivity.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 = new Intent(BrowseActivity.this,MyVideoActivity.class);
                        startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(BrowseActivity.this,AccountActivity.class);
